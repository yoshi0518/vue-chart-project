<template>
  <div class="bar-chart">
    ...
    <div class="chart-area">
      <CompBar :data="chart2.data" :options="chart2.options" />
    </div>
    <div class="description">
      <ul>
    ...
    <div class="chart-area">
      <CompBar :data="chart3.data" :options="chart3.options" />
    </div>
    <div class="description">
      <ul>
        <li>stackedで積み上げを指定</li>
      </ul>
    </div>

    <div class="chart-area">
      <CompBar :data="chart4.data" :options="chart4.options" />
    </div>
    <div class="description">
      <ul>
        <li>stackにより積み上げグループを指定</li>
      </ul>
    </div>
      ...
      chart1: {
        data: {
          ...
          datasets: [
            {
              label: 'A店 来客数',
              data: [62, -24, 93, 85, -34, 66, 47],
            },
            {
              label: 'B店 来客数',
              data: [55, 45, -15, 75, 41, 45, 58],
            },

            {
              label: 'C店 来客数',
              data: [33, 45, 62, -22, 31, 45, -5],
            },
          ],
        },
        options: {
